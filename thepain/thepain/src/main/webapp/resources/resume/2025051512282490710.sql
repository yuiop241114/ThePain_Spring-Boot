...
INSERT INTO JOB_WRITE_POST VALUES (1, '카카오','백엔드 개발자', '정규직', 2300, 2500, '인성이 제일 중요하다고 봅니다. ', 'API 설계 및 유지보수', '컴퓨터공학 전공 우대','Y');
INSERT INTO JOB_WRITE_POST VALUES (2, '네이버','프론트 개발자', '비정규직', 2300, 2500, '대학교 졸업', '디자인 시스템 구축', 'UX 경험 우대','Y');
INSERT INTO JOB_WRITE_POST VALUES (3, '배달의민족','서버 관리자', '기간직', 2300, 2500, '외국어 능력 필수', 'ERD 설계 및 백업관리', 'DBA 경험자 우대','Y');
INSERT INTO JOB_WRITE_POST VALUES (4, '토스','서버 관리자', '시간제 정규직', 2300, 2500, '경력3년차 부터', '전체 서비스 개발', '팀 프로젝트 경험 우대','Y');
INSERT INTO JOB_WRITE_POST VALUES (5, '쿠팡','프로젝트 팀장', '파견직', 2300, 2500, '신입도 가능합니다.', '데이터 처리 및 API화', '딥러닝 경험 우대','Y');
----------------------------------------------------------------------------------
